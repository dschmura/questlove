...
RSpec.describe PanelsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested panel as @panel" do
      panel = Panel.create! valid_attributes
      get :show, params: {id: panel.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested panel as @panel" do
      panel = Panel.create! valid_attributes
      get :edit, params: {id: panel.to_param}, session: valid_session
      expect(assigns(:panel)).to eq(panel)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Panel" do
        expect {
          post :create, params: {panel: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved panel as @panel" do
        post :create, params: {panel: invalid_attributes}, session: valid_session
        expect(assigns(:panel)).to be_a_new(Panel)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested panel" do
        panel = Panel.create! valid_attributes
        put :update, params: {id: panel.to_param, panel: new_attributes}, session: valid_session
        panel.reload
      ...
      it "assigns the requested panel as @panel" do
        panel = Panel.create! valid_attributes
        put :update, params: {id: panel.to_param, panel: valid_attributes}, session: valid_session
        expect(assigns(:panel)).to eq(panel)
      end
    ...
    context "with invalid params" do
      it "assigns the panel as @panel" do
        panel = Panel.create! valid_attributes
        put :update, params: {id: panel.to_param, panel: invalid_attributes}, session: valid_session
        expect(assigns(:panel)).to eq(panel)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested panel" do
      panel = Panel.create! valid_attributes
      expect {
        delete :destroy, params: {id: panel.to_param}, session: valid_session
      }.to change(Panel, :count).by(-1)
    end
